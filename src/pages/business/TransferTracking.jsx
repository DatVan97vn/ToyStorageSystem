...
function getBaseTransferCode(item) {
  return item?.transferCode || item?.code || `TRF-${item?.id || ""}`;
}

function getExportCode(item) {
          ...
          <tbody>
            {loading ? (
              ...
              filteredTransfers.map((item) => (
                <tr key={item.id}>
                  <td>{item.id}</td>
                  <td className="code-cell">{getExportCode(item)}</td>
                  <td className="code-cell">{getReceiveCode(item)}</td>
                  <td>
